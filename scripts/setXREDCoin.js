...
const XREDCoinAddress = '0x35a703c21310cdc73600e835dce285b9badbadee';
...
const tx = XREDTokenSale.at(tokenSaleAddress).setXREDCoin.request(XREDCoinAddress, networkPlaceholderAddress, safeWalletAddress);
...
module.exports = function(callback) {
  return MultiSigWallet.at(multisigAddress)
                 .submitTransaction(XREDTokenSale, 0, data, { gas: 3e5 })
