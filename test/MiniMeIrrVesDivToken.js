...
var XREDTokenSaleTokenMock = artifacts.require("XREDTokenSaleTokenMock");
var MiniMeIrrVesDivToken = artifacts.require("MiniMeIrrVesDivToken");
const timer = require('./helpers/timer');

contract('MiniMeIrrVesDivToken', function(accounts) {
  let token = null;
  let now = 0;
  ...
  beforeEach(async () => {
    const sale = await XREDTokenSaleTokenMock.new(granter, 100);
    token = MiniMeIrrVesDivToken.at(await sale.token());
