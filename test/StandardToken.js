...
var TokenReceiverMock = artifacts.require("./helpers/TokenReceiverMock.sol");
var XREDTokenSaleTokenMock = artifacts.require("./helpers/XREDTokenSaleTokenMock.sol");
var StandardToken = artifacts.require("MiniMeToken.sol");

contract('StandardToken', function(accounts) {
  let token;
  beforeEach(async () => {
    const sale = await XREDTokenSaleTokenMock.new(accounts[0], 86) // 14 extra tokens are 14% extra at sale end
